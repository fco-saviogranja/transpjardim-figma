      ...
      <Card className="shadow-sm border border-[var(--border)]">
        <CardHeader className="bg-[var(--jardim-green-lighter)] border-b border-[var(--border)]">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 lg:mt-0 mt-4">
              ...
              <CollapsibleTrigger asChild>
                <Button variant="ghost" className="w-full mt-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    Histórico de Conclusões Pessoais
                  </div>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="text-muted-foreground">Meta: {criterio.meta}%</span>
                          </div>
